...
public class PriorityQueueImpl2<T extends Comparable<T>> {
    ...
    private void siftDown() {
        ...
        while (index < size) {
            ...
            heap.add(index, heap.get(smallestChildIndex));
            heap.add(smallestChildIndex, temp);
...
//        heap.printList();
    	heap.forEach(e->System.out.println("e "+e));
    ...
    public static void main(String[] args) {
        ...
        // list.remove(2);
        // list.printList();
        PriorityQueueImpl2<Integer> pq = new PriorityQueueImpl2<>();
        pq.add(5);
        pq.add(3);
        pq.add(8);
        pq.add(1);
